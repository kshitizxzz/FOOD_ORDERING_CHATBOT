...
app = FastAPI(title="Food Ordering Chatbot API")
...
# REST API endpoints (used by the web frontend)
...
def remove_order_api(payload: RemoveOrderRequest):
    return remove_from_order({"food-item": payload.food_items}, payload.session_id)
